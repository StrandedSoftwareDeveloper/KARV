...
It and the `Codepage-437.png` (yes, it's still needed despite no visuals in this version yet) in the root of this repository both need to go in `$KSA_DEV_FOLDER`, *not* the mod folder.  
